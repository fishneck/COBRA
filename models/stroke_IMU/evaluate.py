...
#         state_dict = torch.load(args.model)
    if args.model == "best_loss":
        state_dict = torch.load(os.path.join(result_path, "best_loss_model.prm"))
    elif args.model == "best_edit":
        state_dict = torch.load(os.path.join(result_path, "best_edit_model.prm"))
    elif args.model == "best_cer":
        state_dict = torch.load(os.path.join(result_path, "best_cer_model.prm"))
    elif args.model == "best_acc":
        state_dict = torch.load(os.path.join(result_path, "best_acc_model.prm"))
    else:
