...
dataset_names = ["50salads", "gtea", "breakfast","sensors","sensors_all"]


def get_class2id_map(dataset: str, dataset_dir: str = "./dataset") -> Dict[str, int]:
    """
    Args:
        dataset: 50salads, gtea, breakfast, sensors
        dataset_dir: the path to the datset directory
    """

    assert (
        dataset in dataset_names
    ), "You have to choose 50salads, gtea, breakfast or sensors as dataset."
