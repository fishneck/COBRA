...
class ScoreMeter(object):
    ...
    def update(
        ...
        for pred, gt in zip(preds, gts):
            ...
            # calculate the edit distance and cer
            ...
            self.cer_score += levenshtein(p_label, g_label, norm=False)
    ...
    def get_scores(self) -> Tuple[float, float, float]:
        ...
        edit_score = float(self.edit_score) / self.n_videos
         ...
         # edit distance
        cer_score = float(self.cer_score) / self.n_videos
        ...
        return acc, edit_score, cer_score, f1s

    def return_confusion_matrix(self) -> np.ndarray:
        return self.confusion_matrix

    def save_scores(self, save_path: str) -> None:
        acc, edit_score, cer_score, segment_f1s = self.get_scores()
